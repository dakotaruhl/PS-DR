#Connect-PnPOnline https://mstestmaadaruh.sharepoint.com/sites/Training/Shared%20Documents/Forms/AllItems.aspx -Interactive -ClientId 74a6b427-e380-4d01-a58f-f49ff95145b9
    ...
    Try {
        ...
        Function Get-PnPWebPermission([Microsoft.SharePoint.Client.Web]$Web)
        {
            ...
            If($Recursive)
            {
                ...
                $Subweb = Get-PnPProperty -ClientObject $Web -Property Webs
...
ForEach($Site in $SitesCollections)
{
    ...
    $ReportFile = "C:\Users\dakot\Documents\PnP\$($Site.URL.Replace('https://','').Replace('/','_')).CSV"
