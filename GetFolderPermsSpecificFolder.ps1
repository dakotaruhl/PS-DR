...
$FolderSiteRelativeURL = "/Facilities/Building Management - INTERNAL" 
...
$outputFilePath = "C:\Users\DakotaRuhl\Documents\Reports\Permission Reports\$ReportLibrary\MergedPermissionsFile_$ReportLibrary.csv"
