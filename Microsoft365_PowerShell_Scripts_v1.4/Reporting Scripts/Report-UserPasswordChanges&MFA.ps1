...
# V1.3.1 06-12-2025 Replaced command "Get-MgBetaReportAuthenticationMethodUserRegistrationDetail" with "Get-MgReportAuthenticationMethodUserRegistrationDetail"
...
While ($null -ne $Nextlink) {
 ...
 # Get MFA data
 [array]$MFAData = Get-MgReportAuthenticationMethodUserRegistrationDetail -All -PageSize 999
